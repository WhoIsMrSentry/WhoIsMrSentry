...
def _format_html(track: Dict[str, Any], playlist: Dict[str, Any], payload: Dict[str, Any]) -> str:
    ...
    return (
        ...
        f'  <p style="margin:0 0 12px 0;font-size:15px;color:#cccccc;">{artists}</p>\n'
        f'  <p style="margin:0 0 4px 0;font-size:13px;letter-spacing:0.3em;text-transform:uppercase;color:#ffb3c1;">Playlist</p>\n'
        f'  <p style="margin:0 0 16px 0;font-size:17px;font-weight:600;">'
        ...
        'style="flex:1 1 240px;max-width:300px;display:block;">'
        f'<img src="{track_cover}" alt="{track_name} cover art" '
        'style="width:100%;max-width:280px;height:220px;object-fit:cover;border:2px solid #39ff14;border-radius:16px;box-shadow:0 0 12px rgba(57,255,20,0.4);" /></a>\n'
        f'    <a href="{playlist_url}" title="Open {playlist_name}" '
        'style="flex:1 1 240px;max-width:300px;display:block;">'
        f'<img src="{playlist_cover}" alt="{playlist_name} artwork" '
        'style="width:100%;max-width:280px;height:220px;object-fit:cover;border:2px solid #ff0047;border-radius:16px;box-shadow:0 0 12px rgba(255,0,71,0.35);" /></a>\n'
        '  </div>\n'
        f'  <p style="margin-top:14px;font-size:12px;color:#bbbbbb;"><em>Updated {timestamp}</em></p>\n'
        '</div>'
    )
